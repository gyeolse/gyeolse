...
(async () => {
  // RSS 피드 가져오기
  const feed = await parser.parseURL("https://wave-dev-log.tistory.com/rss"); // 수정

  // 최신 5개의 글의 제목과 링크를 추가할 텍스트 생성
  let latestPosts = "### Latest Blog Posts ✏️\n\n";
  ...
  const newReadmeContent = readmeContent.includes("### Latest Blog Posts ✏️")
